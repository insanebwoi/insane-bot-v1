...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Insane bot' : process.env.ALL_CAPTION,
    AFNN: process.env.TAG_REPLY === undefined ? '919746222320@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ∅ ínѕαnє вσt ∅ ‒‒‒⊣' : process.env.BOT_NAME,
